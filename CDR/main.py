# CUDA_VISIBLE_DEVICES=1 python ./CDR/main.py --dataset cifar100 --noise_type symmetric --noise_rate 0.2 --seed 1 
# CUDA_VISIBLE_DEVICES=1 python ./CDR/main.py --dataset cifar100 --noise_type symmetric --noise_rate 0.2 --seed 1 --model_type cifar100_cdr_res18_noise0.2_20220721_seed1
# CUDA_VISIBLE_DEVICES=1 python ./CDR/main.py --dataset cifar100 --noise_type asymmetric --noise_rate 0.2 --seed 1 --model_type 20230216_cifar100_cdr_res18_asnoise0.2_seed1
import os
import torch

...
# CUDA_VISIBLE_DEVICES=0 python ./CDR/main_tire.py --dataset tire --noise_type symmetric --noise_rate 0.2 --model_type tire_cdr_noise_20220425 --seed 123
import os
import torch
...
def main(args):
    ...
    if args.dataset == 'mnist':
        ...
        clf1 = resnet.ResNet18(input_channel=1, num_classes=7)
        optimizer1 = torch.optim.SGD(clf1.parameters(), lr=learning_rate, weight_decay=args.weight_decay, momentum=0.9)
        scheduler1 = MultiStepLR(optimizer1, milestones=[40, 80], gamma=0.1)

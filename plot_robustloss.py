...
l1, = plt.plot(x, ce_acc, label="CE")
l2, = plt.plot(x, mae_acc, label="MAE")
l3, = plt.plot(x, sce_acc, label="SCE")
l4, = plt.plot(x, cemae_acc, label="CE+MAE")
l5, = plt.plot(x, cence_acc, label="CE+NCE")
l6, = plt.plot(x, cenfl_acc, label="CE+NFL")
l7, = plt.plot(x, cenrce_acc, label="CE+NRCE")
l8, = plt.plot(x, cenmae_acc, label="CE+NMAE")
...
# plt.ticklabel_format(style='sci', scilimits=(-1,2), axis='y')
plt.legend(handles=[l1, l2, l3, l4, l5, l6, l7, l8], labels=["CE", "MAE", "SCE", "CE+MAE", "CE+NCE", "CE+NFL", "CE+NRCE", "CE+NMAE"], bbox_to_anchor=(1.31, 1), labelspacing=1, handletextpad=0.2, loc=1)
plt.tick_params(axis='both', which='major')
plt.tick_params(axis='both', which='minor')
plt.grid()
# plt.savefig("cifar10_noise0.4_robustloss_0913.jpg", bbox_inches='tight')
...
# plt.tick_params(axis='both', which='minor', labelsize=14)
# plt.grid()
plt.savefig("cifar10_noise0.6_robustloss_0913.jpg", bbox_inches='tight')
